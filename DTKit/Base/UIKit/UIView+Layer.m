...
+ (UIView *)reflectImage:(UIImage *)image withFrame:(CGRect)frame opacity:(CGFloat)opacity atView:(UIView *)view
{
    ...
    [reflectionLayer setValue:[NSNumber numberWithFloat:dtDegreesToRadians(180)] forKeyPath:@"transform.rotation.x"];
...
{
    self.transform = CGAffineTransformRotate(CGAffineTransformIdentity, M_PI * radians);
}
