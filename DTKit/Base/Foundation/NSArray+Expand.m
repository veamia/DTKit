...
- (NSArray *)randomizedArray {
    ...
    for (NSUInteger i = self.count; i > 1; i--) {
        [results exchangeObjectAtIndex:(i - 1)
...
- (NSArray *)randomizedArray:(NSInteger)count
{
    NSMutableArray *array = (NSMutableArray *)[self randomizedArray];
    return (NSArray *)[array keepHead:count];
}
